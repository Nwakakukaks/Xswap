...
export default function Navbar(props) {
  ...
  return (
    <nav className="max-w-full border-b bg-[#000000]  z-[1000] border-gray-500 backdrop-blur-xl relative w-full flex justify-between items-center px-4  py-3 lg:flex lg:justify-between lg:px-0 font-plus  lg:items-center text-white">
      {!expand ? (
        <span
      ...
      <div className="lg:pl-6 flex justify-between w-[200px] -order-1 lg:w-72">
      ...
      <div className="hidden lg:pr-6 lg:flex items-center">
        <ConnectButton />
      </div>
      {/* --------------- Mobile and Tablets --------------- */}
