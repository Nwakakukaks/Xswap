        ...
        <>
          <div className=" w-full mt-10 flex flex-col justify-center items-center px-2">
            <div className="w-full flex justify-around">
              ...
              <button
                onClick={newPool}
                className="active:scale-95 bg-[#1c9bce] px-3 py-2 text-sm font-semibold rounded-md"
              >
                + New Pool
              </button>
            </div>
            ...
            >
              ...
              <input
                type="range"
                className="mt-3 lg:w-full h-2 bg-[#1c9bce]  rounded-lg appearance-none cursor-pointer form-range p-0 bg-transparent focus:outline-none focus:ring-0 focus:shadow-none"
                min="0"
                max="3"
                step="1"
                id="customRange3"
              ...
              <button
                type="button"
                className="text-white w-full mt-6 bg-[#1c9bce]  text-md font-fredoka active:bg-[#1c9bce]  font-medium rounded-sm px-5 py-2.5 mr-2 mb-2"
                onClick={() => {
                  handleAddliquidity();
                }}
              >
                        ...
                        <tr className=" border-b h-28 border-gray-500 text-gray-100">
                          ...
                          <td className="py-4 px-6 ">
                            ...
                            <button
                              ...
                              className="text-white w-44  bg-[#1c9bce]  text-md font-fredoka active:bg-[#1c9bce]  font-medium rounded-sm px-5 py-2.5 mr- mb-2"
                            >
                              Remove Liquidity
                            </button>
                          </td>
