          ...
          <div className=" w-full mt-10 flex flex-col justify-center items-center px-2 pb-10">
            ...
            >
                ...
                <div className=" text-gray-100  flex  items-center text-lg font-semibold">
                  ...
                  >
                    <div className="relative mt-0">
                      <Listbox.Button className="text-gray-900 relative  cursor-default rounded-md w-28 lg:w-36 px-4 py-2.5 bg-[#1c9bce]  pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
              ...
              <div className=" flex justify-between items-center">
                <div>
                  <button
                    ...
                    type="button"
                    className="text-white mt-6 bg-[#1c9bce]  text-md font-fredoka active:bg-[#1c9bce]  font-medium rounded-sm px-5 py-2.5 mr- mb-2"
                  >
                    Supply
                  </button>
                  <button
                    ...
                    type="button"
                    className="text-white  mt-6 bg-[#1c9bce]  text-md font-fredoka active:bg-[#1c9bce]  font-medium rounded-sm px-5 py-2.5 ml-4 mb-2"
                  >
                    Borrow
                  </button>
                </div>
              ...
              <div className={`${toggleWithdraw ? "visible" : "hidden"} `}>
                ...
                <button
                  type="button"
                  className="text-white w-full  mt-4 bg-[#1c9bce]  text-md font-fredoka active:bg-[#1c9bce]  font-medium rounded-sm px-5 py-2.5 mb-2"
