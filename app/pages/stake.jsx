            ...
            >
                ...
                <div className=" text-gray-100  flex  items-center text-lg font-semibold">
                  ...
                  >
                    <div className="relative mt-0">
                      <Listbox.Button className="relative  cursor-default rounded-md w-28 lg:w-36 px-4 py-2.5 bg-[#1c9bce]  pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
              ...
              <div class="mt-4 relative flex items-center text-white justify-between">
                <div class="mt-4 relative border border-gray-500 py-4 px-6 rounded-sm flex items-center flex-col w-full mr-2 justify-center">
                  ...
                  <button
                    type="button"
                    className="text-black w-72 mt-6 bg-[#1c9bce] text-sm font-fredoka active:bg-[#041529]  font-normal rounded-sm px-5 py-2.5 mr-2 mb-2"
              ...
              <button
                type="button"
                className="text-gray-900 w-full mt-6 bg-[#1c9bce]  text-md font-fredoka active:bg-[#041529]  font-medium rounded-sm px-5 py-2.5 mr-2 mb-2"
                onClick={() => handleStake()}
              >
                Stake
              </button>
